...
class InstagramScraper(object):
    ...
    def is_new_media(self, item):
        ...
        #     return True
        media_timestamp = self.__get_timestamp(item)
        self.logger.warning('Media timestamp is: ' + str(media_timestamp))
        
        #return current_timestamp > 0 and current_timestamp > self.last_scraped_filemtime
        return media_timestamp > 0 and (time.time() - media_timestamp) < 86400
